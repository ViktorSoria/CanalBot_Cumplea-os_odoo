odoo.define('website_customs.recently_viewed', function (require) {
...
publicWidget.registry.productsRecentlyViewedSnippet = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/website_customs/static/src/xml/products_recently_viewed.xml'],
    ...
    _render: function (res) {
        ...
        this.mobileCarousel = $(qweb.render('website_customs.productsRecentlyViewedInherit', {
            uniqueId: this.uniqueId,
            productFrame: 1,
            productsGroups: mobileProducts,
        }));
        this.webCarousel = $(qweb.render('website_customs.productsRecentlyViewedInherit', {
            uniqueId: this.uniqueId,
            productFrame: 4,
